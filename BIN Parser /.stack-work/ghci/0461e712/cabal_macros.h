...
/* package KursachHaskell-0.1.0.0 */
#ifndef VERSION_KursachHaskell
#define VERSION_KursachHaskell "0.1.0.0"
#endif /* VERSION_KursachHaskell */
#ifndef MIN_VERSION_KursachHaskell
#define MIN_VERSION_KursachHaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_KursachHaskell */
...
#define CURRENT_PACKAGE_KEY "KursachHaskell-0.1.0.0-HLjnyDdo40C2AANUQToqh6"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "KursachHaskell-0.1.0.0-HLjnyDdo40C2AANUQToqh6"
